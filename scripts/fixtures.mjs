...
const users = [
    { id: 1, email: 'michel@test.com' },
    { id: 2, email: 'philippe@test.com' },
    { id: 3, email: 'lucie@test.com' },
    { id: 4, email: 'aline@test.com' },
    { id: 5, email: 'bertrand@test.com' },
    { id: 6, email: 'fabienne@test.com' },
];
